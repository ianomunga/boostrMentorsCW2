...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('adminForm').addEventListener('submit', function(e) {
        ...
        switch (action) {
            case 'addStudent':
                sendAjaxRequest('/admin/addStudent', data);
                break;
            case 'addMentor':
                sendAjaxRequest('/admin/addMentor', data);
                break;
            case 'displayStudentByEmail':
                sendAjaxRequest('/admin/displayStudentByEmail', { email: email });
                break;
            case 'displayMentorByName':
                sendAjaxRequest('/admin/displayMentorByName', { name: name });
                break;
            case 'updateStudent':
                sendAjaxRequest('/admin/updateStudent', data);
                break;
            case 'updateMentor':
                sendAjaxRequest('/admin/updateMentor', data);
                break;
            case 'deleteStudent':
                sendAjaxRequest('/admin/deleteStudent', { email: email });
                break;
            case 'deleteMentor':
                sendAjaxRequest('/admin/deleteMentor', { email: email });
                break;
            case 'displayStudents':
                sendAjaxRequest('/admin/displayStudents', {});
                break;
            case 'displayMentors':
                sendAjaxRequest('/admin/displayMentors', {});
                break;
            default:
